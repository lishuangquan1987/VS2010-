...
namespace 获取串口名称
{
    public partial class Form1 : Form
    {
        ...
        public  int GetComNum()
        {
            ...
            string[] _strArr = GetHarewareInfo(HardwareEnum.Win32_SerialPortConfiguration, "Name");
            string[] __strArr = GetHarewareInfo(HardwareEnum.Win32_VideoController, "Name");
        ...
        {
            //int COMName=GetComNum();
            //MessageBox.Show(COMName.ToString());
            HardWareOperation h = new HardWareOperation();
            string name=h.GetHardWareIdFromPortName("COM9");
